...
/**
 * CJPEGFormat é a classe que implementa a manipulação de arquivos de imagens (carregamento e gravação)
 * no formato JPeg.
 * 
...
public class CJPEGFormat extends CFormat
{
	/**
	 * Método sobrescrito da classe pai CFormat para implementar o carregamento do arquivo de imagem de nome dado e no formato JPEG.
	 * Se o arquivo informado não for JPEG, um erro será gerado e o retorno do método será null.
	 * 
	...
	/**
	 * Método sobrescrito da classe pai CFormat para implementar a gravação do arquivo de imagem com o nome dado, no formato JPEG.
	 *
