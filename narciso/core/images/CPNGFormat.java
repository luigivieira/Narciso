...
/**
 * CPNGFormat é a classe que implementa a manipulação de arquivos de imagens (carregamento e gravação)
 * no formato PNG.
 * 
...
public class CPNGFormat extends CFormat
{
	/**
	 * Método sobrescrito da classe pai CFormat para implementar o carregamento do arquivo de imagem de nome dado e no formato PNG.
	 * Se o arquivo informado não for PNG, um erro será gerado e o retorno do método será null.
	 * 
	...
	/**
	 * Método sobrescrito da classe pai CFormat para implementar a gravação do arquivo de imagem com o nome dado, no formato PNG.
	 *
	...
	public int save(PlanarImage pImage, String sFile)
	{
		...
		pPB.add(sFile) ;
		pPB.add("png") ;
		pPB.add(PNGEncodeParam.getDefaultEncodeParam(pImage));
