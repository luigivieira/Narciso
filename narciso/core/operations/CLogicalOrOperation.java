...
/**
 * Classe para a implementação da operação lógica "ou" sobre duas imagens.
 * 
...
public class CLogicalOrOperation extends COperation
{
	/**
	 ...
	 */
	public CLogicalOrOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo apenas uma imagem, resultado operação lógica "ou" das duas imagens dadas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		PlanarImage pTemp = JAI.create("or", pPB, null);
