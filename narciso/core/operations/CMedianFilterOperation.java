...
/**
 * Classe para a implementação da operação de filtro de mediana, sobre todas as imagens dadas.
 * 
...
public class CMedianFilterOperation extends COperation
{
	/**
	 ...
	 */
	public CMedianFilterOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo o mesmo número de imagens de entrada, resultado da aplicação do filtro de mediana em cada uma delas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		for(i = 0; i < pSource.size(); i++)
		{
			...
			pPB.add(MedianFilterDescriptor.MEDIAN_MASK_SQUARE);
			pPB.add(3);
			
			PlanarImage pTemp = JAI.create("medianfilter", pPB, null);
