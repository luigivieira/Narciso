...
/**
 * Classe para a implementação da operação aritimética de subtração sobre duas imagens.
 * 
...
public class CArithmeticSubtractOperation extends COperation
{
	/**
	 ...
	 */
	public CArithmeticSubtractOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo apenas uma imagem, resultado da subtração das duas imagens dadas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		PlanarImage pTemp = JAI.create("subtract", pPB, null);
