...
/**
 * Classe para a implementação da operação lógica "e" sobre duas imagens.
 * 
...
public class CLogicalAndOperation extends COperation
{
	/**
	 ...
	 */
	public CLogicalAndOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo apenas uma imagem, resultado operação lógica "e" das duas imagens dadas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		PlanarImage pTemp = JAI.create("and", pPB, null);
