...
/**
 * Classe para a implementação da operação de detecção de bordas pela aplicação de filtro gradiente com máscara de Frei e Chen,
...
public class CFreiAndChenEdgeGradientOperation extends COperation
{
	/**
	 ...
	 */
	public CFreiAndChenEdgeGradientOperation(String sName, String sDescription)
	{
	 ...
	 *  da detecção de bordas segundo a máscara de Frei e Chen em cada uma delas. Se um erro ocorrer, o retorno será null e o código de
