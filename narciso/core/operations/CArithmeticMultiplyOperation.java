...
/**
 * Classe para a implementação da operação aritimética de multiplicação sobre duas imagens.
 * 
...
public class CArithmeticMultiplyOperation extends COperation
{
	/**
	 ...
	 */
	public CArithmeticMultiplyOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo apenas uma imagem, resultado da multiplicação das duas imagens dadas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		PlanarImage pTemp = JAI.create("multiply", pPB, null);
