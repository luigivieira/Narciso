...
/**
 * Classe para a implementação da operação aritimética de divisão sobre duas imagens.
 * 
...
public class CArithmeticDivideOperation extends COperation
{
	/**
	 ...
	 */	
	public CArithmeticDivideOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo apenas uma imagem, resultado da divisão das duas imagens dadas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		PlanarImage pTemp = JAI.create("divide", pPB, null);
