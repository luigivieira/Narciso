...
/**
 * Classe para a implementação da operação de detecção de bordas pela aplicação de filtro gradiente com máscara em cruz de Robert,
...
public class CRobertsCrossEdgeGradientOperation extends COperation
{
	/**
	 ...
	 */
	public CRobertsCrossEdgeGradientOperation(String sName, String sDescription)
	{
	 ...
	 *  da detecção de bordas segundo a máscara em cruz de Robert em cada uma delas. Se um erro ocorrer, o retorno será null e o código de
