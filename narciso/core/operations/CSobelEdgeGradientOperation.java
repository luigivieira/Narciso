...
/**
 * Classe para a implementação da operação de detecção de bordas pela aplicação de filtro gradiente com máscara de Sobel,
...
public class CSobelEdgeGradientOperation extends COperation
{
	/**
	 ...
	 */
	public CSobelEdgeGradientOperation(String sName, String sDescription)
	{
	 ...
	 *  da detecção de bordas segundo a máscara de Sobel em cada uma delas. Se um erro ocorrer, o retorno será null e o código de
