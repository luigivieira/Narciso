...
/**
 * Classe para a implementação da operação lógica "ou exclusivo" sobre duas imagens.
 * 
...
public class CLogicalXorOperation extends COperation
{
	/**
	 ...
	 */
	public CLogicalXorOperation(String sName, String sDescription)
	{
	 ...
	 *  @return Vetor de objetos básicos do Java contendo apenas uma imagem, resultado operação lógica "ou exclusivo" das duas imagens dadas. Se um erro
	...
	public Vector<Object> execute(Vector<Object> pSource, Properties pParams)
	{
		...
		PlanarImage pTemp = JAI.create("xor", pPB, null);
