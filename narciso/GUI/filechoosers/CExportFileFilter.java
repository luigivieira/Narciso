 ...
 * provê o filtro dos tipos de arquivo permitidos na seleção do nome para exportação de propriedades de
 * uma imagem.
 * 
...
public class CExportFileFilter extends FileFilter
{
	/**
    ...
    public boolean accept(File fFile)
    {
        ...
        if (sExt != null) {
            if (sExt.equals(CUtils.XLS) ||
            	sExt.equals(CUtils.CSV))
                    return true;
            else
                return false;
        }
    ...
    {
        return "Arquivos de Propriedades Suportados (XLS, CSV)";
    }
}