 ...
 * teclado, etc) e a execução, para a ação de exibição da janela de miniaturas (menu Exibir-Imagens Disponíveis).
 * 
...
public class CShowThumbnailsAction extends AbstractAction
{
	...
	public CShowThumbnailsAction()
	{
		...
		putValue(Action.SHORT_DESCRIPTION, "Exibe a janela de miniaturas das imagens disponíveis");
